module.exports=[96890,a=>{"use strict";let b=(0,a.i(27530).default)("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);a.s(["ArrowRight",()=>b],96890)},45429,38689,a=>{"use strict";var b=a.i(27530);let c=(0,b.default)("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]);a.s(["Zap",()=>c],45429);let d=(0,b.default)("Server",[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]]);a.s(["Server",()=>d],38689)},65853,a=>{"use strict";let b={program1:`#include<stdio.h>
#include<stdlib.h>
...
if __name__ == "__main__":
    main()`,program2:`def string_match():
...
string_match()`,program3:`class Stack:
...
st = Stack(); st.push(1); st.push(2); st.push(1); st.display(); st.is_palindrome()`,program4:`def priority(op):
    if op == '(': return 0
    if op in '+-': return 1
    if op in '*/%': return 2
    if op == '^': return 3
...
infix_to_postfix("a+b*c")`,program5a:`def evaluate_postfix(exp):
    stack = []
    for char in exp:
...
evaluate_postfix("23+")`,program5b:`def tower(n, s, t, d):
    if n == 0: return
    tower(n-1, s, d, t)
    print(f"Move {n} from {s} to {d}")
    tower(n-1, t, s, d)

tower(3, 'A', 'B', 'C')`,program6:`class CircularQueue:
    def __init__(self, size=5):
        self.size = size
        self.q = [None] * size
        self.f = self.r = -1
...
cq = CircularQueue(); cq.insert('A'); cq.display()`,program7:`class Node:
...
s = SLL(); s.insert_front("1", "Alice"); s.display()`,program8:`class Node:
...
d = DLL(); d.insert_end("E1", "Bob"); d.display()`,program9:`class Node:
...
p = Poly(); p.insert(3, 2, 1, 0); print(p.evaluate(1, 2, 3))`,program10:`class Node:
    def __init__(self, d):
...
root = None; root = insert(root, 5); root = insert(root, 3); inorder(root)`,program11:`def bfs(adj, s):
    visited, queue = {s}, [s]
    while queue:
        u = queue.pop(0)
        print(u, end=" ")
...
bfs({0: [1, 2], 1: [0, 3], 2: [0, 3], 3: [1, 2]}, 0)`,program12:`def hashing(m, keys):
    ht = [-1] * m
    for k in keys:
        idx = k % m
        while ht[idx] != -1: idx = (idx + 1) % m
...
hashing(10, [15, 25, 35])`},e={program1:`import java.util.Scanner;
...
}`};a.s(["CPP_CODE",0,c,"C_CODE",0,b,"JAVA_CODE",0,e,"PYTHON_CODE",0,d,"programsData",0,[{id:"program1",name:"Program 1",category:"Basic",difficulty:"Easy",time:"O(1)",space:"O(1)"},{id:"program2",name:"Program 2",category:"Strings",difficulty:"Easy",time:"O(N)",space:"O(N)"},{id:"program3",name:"Program 3",category:"Stack",difficulty:"Easy",time:"O(N)",space:"O(N)"},{id:"program4",name:"Program 4",category:"Queue",difficulty:"Easy",time:"O(N)",space:"O(N)"},{id:"program5a",name:"Program 5A",category:"Recursion",difficulty:"Medium",time:"O(N)",space:"O(N)"},{id:"program5b",name:"Program 5B",category:"Recursion",difficulty:"Medium",time:"O(2^N)",space:"O(N)"},{id:"program6",name:"Program 6",category:"Circular Queue",difficulty:"Medium",time:"O(1)",space:"O(N)"},{id:"program7",name:"Program 7",category:"Linked List",difficulty:"Medium",time:"O(N)",space:"O(N)"},{id:"program8",name:"Program 8",category:"Linked List",difficulty:"Medium",time:"O(N)",space:"O(N)"},{id:"program9",name:"Program 9",category:"Polynomial",difficulty:"Hard",time:"O(N*M)",space:"O(N+M)"},{id:"program10",name:"Program 10",category:"BST",difficulty:"Hard",time:"O(H)",space:"O(H)"},{id:"program11",name:"Program 11",category:"Graphs",difficulty:"Hard",time:"O(V+E)",space:"O(V)"},{id:"program12",name:"Program 12",category:"Hashing",difficulty:"Medium",time:"O(1) avg",space:"O(M)"}]])}];

//# sourceMappingURL=DSA-with-tsx_43759be7._.js.map