...
import { Moon, Sun, ChevronDown, Code2, Home, User, Mail, MapPin, Briefcase, GraduationCap, Copy, Check, Menu, X, BookOpen, ArrowRight, Map, Eye, Bug, Server, BarChart3, Network, Search, Trophy, Zap, Clock, Terminal, ChevronRight, Package, Github, Linkedin } from 'lucide-react';
        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="flex items-center h-16 px-4">
            ...
            <div className="flex-1 flex justify-start items-center">
              <h1 className="text-xl lg:text-2xl font-bold text-orange-500 whitespace-nowrap cursor-pointer" onClick={() => {resetProgramState(); window.location.hash = 'home';}}>
                DSA Study Hub
              </h1>
            </div>
            ...
            <div className="hidden md:flex flex-shrink-0 items-center justify-center space-x-2 lg:space-x-4">
              ...
              <div className="relative programs-dropdown">
                <button onClick={(e) => { e.stopPropagation(); setIsProgramsOpen(!isProgramsOpen); }} className="flex items-center space-x-1 hover:text-orange-500 transition-colors"><Code2 size={18} /><span>Programs</span><ChevronDown size={14} /></button>
                {isProgramsOpen && (
              ...
              <div className="relative notes-dropdown">
                <button onClick={(e) => { e.stopPropagation(); setIsNotesOpen(!isNotesOpen); }} className="flex items-center space-x-1 hover:text-orange-500 transition-colors"><BookOpen size={18} /><span>Notes</span><ChevronDown size={14} /></button>
                {isNotesOpen && (
              ...
              <button onClick={() => {resetProgramState(); window.location.hash = 'knapsack';}} className="flex items-center space-x-1 hover:text-orange-500 transition-colors"><Package size={18} /><span>Knapsack</span></button>
              ...
              <button onClick={() => {resetProgramState(); window.location.hash = 'tree-graph';}} className="flex items-center space-x-1 hover:text-orange-500 transition-colors"><Network size={18} /><span>Trees</span></button>
              <button onClick={() => {resetProgramState(); window.location.hash = 'system-design';}} className="flex items-center space-x-1 hover:text-orange-500 transition-colors"><Server size={18} /><span>Design</span></button>
            ...
            <div className="flex-1 flex items-center justify-end space-x-2">
              <button onClick={() => setIsSearchOpen(true)} className="p-2 rounded-full hover:bg-orange-500/10 transition-colors text-gray-700 dark:text-gray-200" title="Search">
                <Search size={22} />
              </button>
              <button onClick={toggleTheme} className="hidden md:flex p-2 rounded-full hover:bg-orange-500/10 text-gray-700 dark:text-gray-200">
                {darkMode ? <Sun size={22} /> : <Moon size={22} />}
              </button>

              {/* Mobile Menu Button - shows on right */}
              <div className="md:hidden flex items-center">
                <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 text-gray-700 dark:text-gray-200 hover:text-orange-500 transition-colors">
            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-white/5 backdrop-blur-md">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/3 p-8 bg-white dark:bg-gray-800/20 flex flex-col items-center border-r border-gray-100 dark:border-white/5">
                  ...
                  <h2 className="mt-8 text-3xl font-bold text-gray-900 dark:text-white text-center">Pranav Arun</h2>
                  <p className="text-orange-500 font-semibold mt-1">Full Stack Developer</p>
                  
                  {/* Social Buttons */}
                  <div className="flex gap-3 mt-8">
                    <a href="https://github.com/toxicbishop" target="_blank" rel="noopener noreferrer" className="p-3 bg-white dark:bg-gray-700 rounded-2xl shadow-md text-gray-700 dark:text-gray-200 hover:text-orange-500 transition-all hover:scale-110 hover:shadow-orange-500/20">
                      <Github size={20} />
                    </a>
                    <a href="https://www.linkedin.com/in/pranav-arun/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white dark:bg-gray-700 rounded-2xl shadow-md text-gray-700 dark:text-gray-200 hover:text-blue-500 transition-all hover:scale-110 hover:shadow-blue-500/20">
                      <Linkedin size={20} />
                    </a>
                    <a href="mailto:pranavarun19@gmail.com" className="p-3 bg-white dark:bg-gray-700 rounded-2xl shadow-md text-gray-700 dark:text-gray-200 hover:text-red-500 transition-all hover:scale-110 hover:shadow-red-500/20">
                      <Mail size={20} />
                    </a>
                  </div>
                </div>
                ...
                <div className="md:w-2/3 p-8 md:p-12 space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                      Hello! I'm a passionate developer currently pursuing my B.E. in Computer Science & Business Systems at <strong className="text-gray-900 dark:text-white">KSSEM (K.S. School of Engineering and Management)</strong>, Bengaluru.
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      My journey in tech is driven by an insatiable curiosity for how things work under the hood. I built <strong className="text-gray-900 dark:text-white">DSA Study Hub</strong> to bridge the gap between complex algorithms and intuitive learning. Whether it's pathfinding visualizations or dynamic programming breakdowns, I believe technology should make learning accessible and engaging for everyone.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-center space-x-4 p-4 rounded-2xl bg-gray-50 dark:bg-gray-900/50 hover:bg-orange-500/5 transition-colors border border-transparent hover:border-orange-500/20">
                      ...
                      <div>
                        <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Degree</p>
                        <p className="font-semibold text-gray-900 dark:text-gray-100">B.E in CS&BS</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4 p-4 rounded-2xl bg-gray-50 dark:bg-gray-900/50 hover:bg-pink-500/5 transition-colors border border-transparent hover:border-pink-500/20">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 dark:text-gray-100">Bengaluru, India</p>
                      </div>
                    </div>
                  </div>
                </div>
               ...
               <div className="md:col-span-2 p-8 rounded-3xl bg-white dark:bg-gray-800/50 shadow-xl border border-gray-100 dark:border-white/5 backdrop-blur-md">
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                   {[
                     ...
                     <div key={skill.name} className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-700/50 text-center group hover:-translate-y-1 transition-all duration-300">
                        <p className="text-sm font-bold text-gray-700 dark:text-gray-200 mb-2">{skill.name}</p>
                        <div className="w-full h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                           <div className={`h-full bg-orange-500 transition-all duration-1000`} style={{ width: skill.level }}></div>
                        </div>
                     </div>
                   ))}
                 </div>
                 ...
                 <div className="relative">
                    ...
                    <ul className="space-y-4">
                       <li className="flex items-start gap-3">
                          <Check size={18} className="mt-1 flex-shrink-0 text-orange-500" />
                          <p className="text-sm text-gray-600 dark:text-gray-300">Mastering Advanced Graph Traversal logic.</p>
                       </li>
                       <li className="flex items-start gap-3">
                          <Check size={18} className="mt-1 flex-shrink-0 text-pink-500" />
                          <p className="text-sm text-gray-600 dark:text-gray-300">Building more intuitive System Design breakdowns.</p>
                       </li>
                       <li className="flex items-start gap-3">
                          <Check size={18} className="mt-1 flex-shrink-0 text-orange-400" />
                          <p className="text-sm text-gray-600 dark:text-gray-300">Contributing to open-source educational tools.</p>
                       </li>
                    </ul>
                 </div>
