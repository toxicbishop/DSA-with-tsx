...
const AdminDashboardView = lazy(() =>
  import("./views/AdminDashboardView").then((m) => ({
...
function App() {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAdminLoginError("Connection error. Is the server running?");
    } finally {
    ...
    <div
      ...
      {isAdminModalOpen && (
        <div
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 w-full max-w-sm shadow-2xl shadow-black/50 animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAdminLogin} className="space-y-4">
              <div className="relative">
                <input
                  ...
                  autoFocus
                  className="w-full bg-gray-800 border border-gray-700 text-white placeholder-gray-500 rounded-xl px-4 py-3 pr-11 text-sm focus:outline-none focus:border-violet-500 transition-colors"
                />
                <button
                  type="button"
              ...
              <button
                type="submit"
                disabled={!adminPassword || adminLoginLoading}
                className="w-full bg-violet-600 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-medium py-3 rounded-xl text-sm transition-all flex items-center justify-center gap-2">
                {adminLoginLoading ? (
                  <>
      ...
      <footer className="bg-slate-900 text-gray-300 py-16 mt-20 border-t border-slate-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            {/* Subtle admin entry — low visibility by design */}
            <button
