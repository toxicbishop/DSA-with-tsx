        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-5">
              ...
              {/* GitHub Icon */}
              <a href="#" className="p-2 bg-slate-800 rounded-full hover:bg-orange-600 hover:text-white transition-all group">
              ...
              {/* LinkedIn Icon */}
              <a href="#" className="p-2 bg-slate-800 rounded-full hover:bg-blue-600 hover:text-white transition-all group">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* Instagram/Web Icon */}
              <a href="#" className="p-2 bg-slate-800 rounded-full hover:bg-pink-600 hover:text-white transition-all group">
