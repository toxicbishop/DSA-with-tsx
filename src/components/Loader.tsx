            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="relative mb-8">
                    ...
                    <div className="relative p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 animate-bounce-subtle">
                        <Code2 size={48} className="text-orange-500 animate-pulse" />
                    </div>
                </div>

                {/* Loading Text */}
                <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-amber-500 mb-4 animate-fade-in-up">
                    DSA Study Hub
                </h1>
                ...
                <div className="mt-4 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 font-mono">
                    <Terminal size={14} />
                    <span className="animate-typewriter">Initializing system resources...</span>
                </div>
            </div>
        </div>
    );
